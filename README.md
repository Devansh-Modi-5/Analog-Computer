...
**Modeling Non-linear Dynamical Systems using Analog Computer**
  ...
  *Validated system response experimentally and compared with MATLAB simulations.

  *Investigated challenges in implementing non-zero initial condition integrators for analog computation.

  *Proposed extension toward chaotic system modeling (Lorenz attractor).
